				...
				<div class="card" >
					<div class="card-header" style="background-color: lightblue"> <?php echo $sub_judul; ?></div>
  					<div class="card-body" style="background-color: lightgreen">
  						<div class="card-header " style="background-color: pink"> PENGUMUMAN</div>
    <h5 class="card-title">Perayaan Hari IBU</h5>
    <p class="card-text">Sehubung dengan perayaan hari ibu maka kamim memberikan diskount</p>
    ...
    <div class="card-body" style="background-color: lightyellow">
     ...
     <a href="<?php echo site_url('admin/pengumuman/tambah')?>" class="btn btn-primary">Tambah Data</a>
      ...
      <div style="border: 1px solid pink; padding: 15px; margin-bottom: 13px">
        ...
        <div class="row">
        <div class="col-sm-1" ><img  height="100px" width="100px" src="<?= base_url('assets/Tulips.jpg') ?>" class="img-thumbnail">
        </div>
        <div class="col-sm-9">
